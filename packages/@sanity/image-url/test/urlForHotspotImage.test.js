...
describe('urlForHotspotImage', () => {
  ...
  it('does does not crop, but limits size when only height dimension is specified', () => {
    should(
      urlForHotspotImage({source: uncroppedImage(), projectId: 'zp7mbokg', dataset: 'production', height: 100})
  ...
  it('a tall crop is centered on the hotspot', () => {
    should(
      urlForHotspotImage({source: uncroppedImage(), projectId: 'zp7mbokg', dataset: 'production', width: 30, height: 100})
  ...
  it('a wide crop is centered on the hotspot', () => {
    should(
      urlForHotspotImage({source: uncroppedImage(), projectId: 'zp7mbokg', dataset: 'production', width: 100, height: 30})
  ...
  it('a crop with identical aspect and no specified crop is not cropped', () => {
    should(
      urlForHotspotImage({source: uncroppedImage(), projectId: 'zp7mbokg', dataset: 'production', width: 200, height: 300})
  ...
  it('a tall crop is centered on the hotspot and constrained within the image crop', () => {
    should(
      urlForHotspotImage({source: croppedImage(), projectId: 'zp7mbokg', dataset: 'production', width: 30, height: 100})
  ...
  it('ignores the image crop if caller specifies another', () => {
    should(
      urlForHotspotImage({source: croppedImage(), rect: {left: 10, top: 20, width: 30, height: 40},
        projectId: 'zp7mbokg', dataset: 'production', width: 30, height: 100})
    ).equal('https://cdn.sanity.io/images/zp7mbokg/production/Tb9Ew8CXIwaY6R1kjMvI0uRR-2000x3000.jpg?rect=10,20,30,40&w=30&h=100')
  })

  it('gracefully handles a non-hostpot image', () => {
    should(
      urlForHotspotImage({source: noHostpotImage(), projectId: 'zp7mbokg', dataset: 'production', height: 100})
    ).equal('https://cdn.sanity.io/images/zp7mbokg/production/Tb9Ew8CXIwaY6R1kjMvI0uRR-2000x3000.jpg?h=100')
  })
})
