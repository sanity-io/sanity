...
export default class ImmutableAccessor {
  ...
  // Replaces the content of this accessor with another accessor. Since this is the immutable impementation,
  // it just returns the new accessor as the new value.
  setAccessor(accessor: ImmutableAccessor) : ImmutableAccessor {
    return accessor
  }
  ...
  setIndexAccessor(i: number, accessor: ImmutableAccessor) {
  ...
  setAttributeAccessor(key: string, accessor: ImmutableAccessor) {
