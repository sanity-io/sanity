...
import {findNamedQueriesInSource} from '../findQueriesInSource'
...
describe('findQueries with the groq template', () => {
  describe('should find queries in source', () => {
    ...
    `
      ...
      const queries = findNamedQueriesInSource(source, 'test.ts')
  ...
  test('should import', () => {
    ...
    `
    const queries = findNamedQueriesInSource(source, __filename, undefined)
