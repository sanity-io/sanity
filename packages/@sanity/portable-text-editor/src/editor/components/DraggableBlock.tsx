import React, {useState, useRef, useMemo, DragEvent, useEffect} from 'react'
...
export const DraggableBlock = ({children, element, readOnly, blockRef}: DraggableBlockProps) => {
  ...
  const handleDragLeave = useCallbackWithTryCatch(
    ...
    [],
    'DraggableBlock:handleDragLeave',
  )
  ...
  const handleDragStart = useCallbackWithTryCatch(
    ...
    'DraggableBlock:handleDragStart',
  )
