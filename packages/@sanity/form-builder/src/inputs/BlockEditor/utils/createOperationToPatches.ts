...
import {InsertPosition} from '../../../typedefs/patch'
...
export default function createOperationToPatches(
  ...
  return function operationToPatches(
    ...
    beforeValue: SlateValue,
    afterValue: SlateValue,
    formBuilderValue?: FormBuilderValue[] | null // This is optional, but needed for setting setIfMissing patches correctly
  ) {
