...
export default class BlockObject extends React.Component<Props, State> {
  ...
  _dragGhost: HTMLElement | null = null
  ...
  handleFocus = (event: React.MouseEvent) => {
    event.stopPropagation()
  ...
  refPreview = (previewContainer: HTMLDivElement | null) => {
  ...
  renderPreview = (value: FormBuilderValue | any) => {
