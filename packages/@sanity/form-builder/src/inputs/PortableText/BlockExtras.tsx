...
export default function BlockExtras(props: Props) {
  const {block, blockActions, isFullscreen, markers, hasFocus, onFocus, renderCustomMarkers} = props
  ...
  const blockExtras = isFullscreen ? contentWithChangeIndicators : content
