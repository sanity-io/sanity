...
export class ArrayInput extends React.Component<Props> {
  ...
  render() {
    ...
    const FieldSetComponent = supportDirectUploads ? UploadTargetFieldset : FormFieldSet
    const uploadProps = supportDirectUploads
