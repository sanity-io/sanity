import {ChangeIndicatorScope} from '@sanity/base/lib/__legacy/components/change-indicators'
import {ContextProvidedChangeIndicator} from '@sanity/base/lib/__legacy/components/change-indicators/ChangeIndicator'
import {ArraySchemaType, isValidationMarker, Marker, Path, SchemaType} from '@sanity/types'
import * as PathUtils from '@sanity/util/paths'
import LinkIcon from 'part:@sanity/base/link-icon'
import {FormFieldPresence, FieldPresence, PresenceOverlay} from '@sanity/base/__legacy/presence'
