...
const textComponents = {
  types: {
    ...
    products: ({ value }) =>
      value?.products ? <Box paddingY={3}><Products heading="Favourite toys & treats" products={value?.products} /></Box> : null,
  },
  block: {
...
export function BlockText(props) {
  ...
  return <Stack space={5}><PortableText value={value} components={textComponents} /></Stack>;
}
