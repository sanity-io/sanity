/* oxlint-disable typescript/no-deprecated -- these tests assert the legacy Rule representation */
import {type NumberSchemaType, type SchemaType, type StringSchemaType} from '@sanity/types'
import {describe, expect, it} from 'vitest'

import {normalizeValidationRules, Rule as RuleClass} from '../../src/_internal'
