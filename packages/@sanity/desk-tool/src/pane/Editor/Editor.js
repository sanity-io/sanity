...
export default class Editor extends React.PureComponent {
    ...
    return (
      <>
        ...
        <RestoreHistoryButton
          ...
          onRestore={() => onRestore({id: selectedEvent.displayDocumentId, rev: selectedEvent.rev})}
        />
      </>
    )
  }
  ...
  render() {
    ...
    const {inspect, showConfirmDelete, showConfirmUnpublish, didPublish, historyState} = this.state
