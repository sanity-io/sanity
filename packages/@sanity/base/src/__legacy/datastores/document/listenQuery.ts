...
const fetch = (query: string, params: Record<string, any>) =>
  defer(() => client.observable.fetch(query, params))

const listen = (query: string, params: Record<string, any>) =>
  defer(() =>
...
export const listenQuery = (query: string, params: Record<string, any>) => {
