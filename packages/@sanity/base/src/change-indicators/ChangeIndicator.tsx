...
export const ChangeIndicatorProvider = React.memo(function ChangeIndicatorProvider(props: {
  ...
  const fullPath = PathUtils.pathFor(parentContext.fullPath.concat(props.path))
...
export const ChangeIndicatorWithProvidedFullPath = ({
  ...
  const fullPath = PathUtils.pathFor(parentContext.fullPath.concat(canonicalPath))
  ...
  return (
    <CoreChangeIndicator
      ...
      className={className}
      value={value}
      compareValue={PathUtils.get(parentContext.compareValue, fullPath)}
      hasFocus={hasFocus}
      fullPath={fullPath}
...
export const ChangeIndicatorCompareValueProvider = (props: {
  ...
  const contextValue = React.useMemo(() => {
    return {
      value: props.value,
      compareValue: props.compareValue,
      focusPath: PathUtils.pathFor(parentContext.focusPath || []),
