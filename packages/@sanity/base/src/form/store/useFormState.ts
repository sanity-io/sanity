...
export function useFormState(
  ...
  onSetFieldGroupState: (nextState: StateTree<string>) => void
  onSetExpandedNode: (nextState: StateTree<boolean>) => void
  onSetExpandedFieldSets: (nextState: StateTree<boolean>) => void
} {
  ...
  return {formState, onSetFieldGroupState, onSetExpandedFieldSets, onSetExpandedNode}
}
