...
export interface DocumentPaneContextValue {
  ...
  handleSetActiveFieldGroup: (path: Path, groupName: string) => void
  handleOnSetCollapsedPath: (path: Path, collapsed: boolean) => void
  handleOnSetCollapsedFieldSet: (path: Path, collapsed: boolean) => void
