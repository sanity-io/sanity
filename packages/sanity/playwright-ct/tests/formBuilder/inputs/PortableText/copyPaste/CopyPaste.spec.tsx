...
import {GDOCS_INPUT, NORMALIZED_INPUT_SNAPSHOT, REMOVED_INPUT_SNAPSHOT, UNICODE_TEXT} from './input'
...
test.describe('Portable Text Input', () => {
  ...
  test.describe('Should be able to paste text that has hidden unicode characters without bloating the PTE', () => {
    test(`Removed unicode characters`, async ({mount, page}) => {
      ...
      // prettier-ignore
      const lengthBodyChildren = JSON.stringify(documentState?.body).length || 0
      // prettier-ignore
      const lengthSnapshotChildren = Object.keys(documentState?.body[0].children).length
