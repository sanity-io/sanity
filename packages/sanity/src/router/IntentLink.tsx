 ...
 * ```
 */
export const IntentLink: ForwardRefExoticComponent<
  IntentLinkProps & HTMLProps<HTMLAnchorElement> & RefAttributes<HTMLAnchorElement>
> = forwardRef(function IntentLink(
