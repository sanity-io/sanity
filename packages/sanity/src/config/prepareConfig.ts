...
function resolveSource({
  ...
  const source: Source = {
    ...
    form: {
      components: {
        Field: _createRenderFormComponent<Omit<FieldProps, 'renderNext'>>({
          componentName: 'Field',
          config,
        }),
        Input: _createRenderFormComponent<Omit<InputProps, 'renderNext'>>({
          componentName: 'Input',
          config,
        }),
        Item: _createRenderFormComponent<Omit<ItemProps, 'renderNext'>>({
          componentName: 'Item',
          config,
        }),
        Preview: _createRenderFormComponent<Omit<PreviewProps, 'renderNext'>>({
