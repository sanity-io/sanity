...
describe('useDocumentLocations', () => {
  ...
  it('keeps the resolved locations when the subscription is re-created without a remount', async () => {
    ...
    // Hiding the tool tears the subscription down; react-rx releases the shared source a tick
    // later, so the next subscription starts the resolver observable over from scratch.
