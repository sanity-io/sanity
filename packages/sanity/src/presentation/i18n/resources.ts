export default {
  ...
  'preview-frame.configuration.error.description':
    'The preview iframe is configured to load <Code>{{targetOrigin}}</Code>, but the reported origin is <Code>{{reportedOrigin}}</Code>. Presentation Tool is unable to connect to unknown origins for security purposes. Update your <Code>presentationTool.allow</Code> configuration to allow connecting to Visual Editing and Loaders.',
