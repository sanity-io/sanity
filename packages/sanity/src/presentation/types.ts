...
/**
 * @deprecated the `previewUrl.initial`, `previewUrl.allow` and `previewUrl.previewMode.enable` supports async functions that offer advanced control over how preview URLs are resolved
 * @public
 */
export type DeprecatedPreviewUrlResolver = PreviewUrlResolver<SanityClient>

/** @public */
export type PreviewUrlResolverOptions = PreviewUrlOptions
