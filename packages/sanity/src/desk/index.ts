...
import {type DocumentListPaneProps as _DocumentListPaneProps} from '../structure/panes/documentList'
import {PaneContainer as _DocumentListPane} from '../structure/panes/documentList/PaneContainer'
import {
...
import {
  type MenuItem as _DeskToolMenuItem,
...
import {component as _component, form as _form} from '../structure/structureBuilder/views'
import {
 ...
 * @beta
 */
export type {BaseResolvedPaneNode} from '../structure/types'
/**
 * @deprecated Import from `sanity/structure` instead
 * @hidden
 * @beta
 ...
 * @beta
 */
export type {Serializable} from '../structure/structureBuilder/StructureNodes'
/**
 * @deprecated Import from `sanity/structure` instead
 * @hidden
 * @beta
