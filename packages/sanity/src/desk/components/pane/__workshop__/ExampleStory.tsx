...
import {Button, Container, PopoverProvider, Stack, Tab, TabList, Text} from '@sanity/ui'
            ...
            <Container paddingX={4} paddingY={[4, 4, 5]} sizing="border" width={1}>
              <Stack space={4}>
                <Text muted>
                  ...
                  ac scelerisque molestie. Cras mi turpis, vestibulum vel ultrices sit amet,
                  imperdiet vel tortor.
                </Text>
                <Text muted>
                  Curabitur vel viverra nunc. Mauris vel tellus a ante porta aliquet. Nam in est
                  augue. Nullam lacinia sapien sit amet placerat consequat. Vivamus aliquam in orci
                  in semper. Integer vehicula elementum ante et gravida. Suspendisse commodo sodales
                  quam dignissim lobortis. Praesent ultrices elit in orci vehicula, at sollicitudin
                  nisl venenatis. Nunc porttitor risus ac leo auctor rhoncus. Proin pharetra posuere
                  commodo. Vivamus vel elementum magna, quis iaculis justo. Donec nisl mauris,
                  blandit a augue nec, elementum vulputate lacus. Donec sodales ipsum in ante
                  ultricies, bibendum tincidunt massa pharetra.
                </Text>
                <Text muted>
                  Phasellus et purus id nisl efficitur luctus eu id risus. Phasellus lacinia
                  efficitur quam. Nulla id malesuada quam. Cras a nibh ut felis tincidunt mattis.
                  Maecenas sit amet massa et ex tincidunt elementum. Nam vehicula eu dolor sed
                  ornare. Vestibulum rhoncus diam non imperdiet pellentesque. Cras lacinia, diam
                  eget efficitur ullamcorper, quam sem accumsan nibh, ac pulvinar tortor risus id
                  neque. In gravida felis lectus, nec scelerisque ante ornare euismod. Quisque vitae
                  nibh commodo, cursus erat vel, eleifend urna. Nullam eu commodo ante.
                </Text>
                <Text muted>
                  ...
                  feugiat. In hac habitasse platea dictumst. Maecenas eu nisi bibendum, malesuada
                  leo vitae, accumsan tellus. Etiam fermentum ipsum a erat eleifend, eu ultrices
                  nibh semper.
                </Text>
                <Text muted>
                  ...
                  mollis erat. Ut in rhoncus tortor. Fusce faucibus ullamcorper justo, eu semper
                  massa faucibus eu. Donec sed mauris non ligula placerat cursus. In et dui
                  faucibus, eleifend sem nec, scelerisque urna. Nunc mollis eros vitae egestas
                  facilisis. Duis ut metus interdum, ultrices magna non, imperdiet dui. Etiam mattis
                  et ex varius aliquet. Ut vestibulum dolor est, ut aliquam diam ullamcorper sit
                  amet. Cras ac urna quis augue tincidunt aliquam ut at augue. Mauris et sapien
                  vitae lacus molestie fringilla. Vivamus eu finibus mauris. Nulla dignissim
                  tincidunt nulla, a egestas sem dignissim id. Pellentesque sit amet magna ac dolor
                  laoreet placerat eu a massa.
                </Text>
