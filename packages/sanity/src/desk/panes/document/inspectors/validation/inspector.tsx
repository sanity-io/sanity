...
import {Box, Button, Card, CardTone, ErrorBoundary, Flex, Stack, Text} from '@sanity/ui'
...
export default function ValidationInspector(props: DocumentInspectorProps) {
  const {onClose} = props
    ...
    <Flex direction="column" height="fill" overflow="hidden">
      <DocumentInspectorHeaderCard as="header" flex="none">
        <Flex padding={3}>
          ...
          <Box flex="none" style={{lineHeight: 0}}>
            <Button
