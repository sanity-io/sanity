...
const structureLocaleStrings = defineLocalesResources('structure', {
  ...
  'banners.scheduled-draft-override-banner.text':
    'A scheduled draft for this document exists. If you publish changes now they will be overwritten when the schedule runs. To make updates, first delete the scheduled draft.',
