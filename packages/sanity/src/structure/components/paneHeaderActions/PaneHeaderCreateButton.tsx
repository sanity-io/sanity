...
const getIntent = (
  ...
  const baseParams = {
    ...
    type: typeName,
    // Is it necessary to force the id after the document pair change?
    // Or it will be enough with the searchParam addition?
    id: isBundleIntent ? `${version}.${uuid()}` : item.initialDocumentId,
  }
