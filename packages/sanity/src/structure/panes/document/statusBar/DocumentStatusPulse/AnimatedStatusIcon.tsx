...
import {styledMotionPath, rotateGroup, rotateGroupAnimating} from './AnimatedStatusIcon.css'
...
const Arrows = (props: MotionPathProps) => (
  <motion.path className={styledMotionPath}
    fill="none"
  ...
  return (
    ...
    >
      <motion.g variants={root} initial={status} animate={status}>
        <g className={status === 'changes' ? rotateGroup : rotateGroupAnimating}>
