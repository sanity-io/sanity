...
globalStyle(
  `${jsonInspectorWrapper} .json-inspector, ${jsonInspectorWrapper} .json-inspector .json-inspector__selection`,
  {
...
globalStyle(
  `${jsonInspectorWrapper} .json-inspector .json-inspector__leaf.json-inspector__leaf_root`,
  {
...
globalStyle(
  `${jsonInspectorWrapper} .json-inspector > .json-inspector__leaf_root > .json-inspector__line > .json-inspector__key`,
  {
    display: 'none',
  },
)
...
globalStyle(
  `${jsonInspectorWrapper} .json-inspector .json-inspector__leaf_composite > .json-inspector__line`,
  {
    cursor: 'pointer',
  },
)
...
globalStyle(
  `${jsonInspectorWrapper} .json-inspector .json-inspector__leaf_composite > .json-inspector__line::before`,
  {
    content: "'▸ '",
    // Copied verbatim from the styled-components template (unitless `0` minus a length).
    marginLeft: `calc(0 - ${space4Var} + 3px)`,
    fontSize: codeFontSizeVar,
    lineHeight: codeLineHeightVar,
  },
)
...
globalStyle(
  `${jsonInspectorWrapper} .json-inspector .json-inspector__leaf_expanded.json-inspector__leaf_composite > .json-inspector__line::before`,
  {
    content: "'▾ '",
    fontSize: codeFontSizeVar,
    lineHeight: codeLineHeightVar,
...
globalStyle(
  `${jsonInspectorWrapper} .json-inspector .json-inspector__radio, ${jsonInspectorWrapper} .json-inspector .json-inspector__flatpath`,
  {
    display: 'none',
  },
)
...
globalStyle(
  `${jsonInspectorWrapper} .json-inspector > .json-inspector__leaf_root > .json-inspector__line > .json-inspector__key + .json-inspector__value`,
  {
    margin: 0,
  },
)
...
globalStyle(
  `${jsonInspectorWrapper} .json-inspector .json-inspector__value_helper, ${jsonInspectorWrapper} .json-inspector .json-inspector__value_null`,
  {
