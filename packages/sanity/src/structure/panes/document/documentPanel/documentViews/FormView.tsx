...
import {type FormEvent, forwardRef, memo, useCallback, useEffect, useMemo, useState} from 'react'
...
export const FormView = memo(
  forwardRef<HTMLDivElement, FormViewProps>(function FormView(props, ref) {
