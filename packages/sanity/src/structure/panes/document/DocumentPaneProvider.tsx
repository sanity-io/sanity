...
export const DocumentPaneProviderInner = memo(
  ...
  (
    ...
    const selectedReleaseId = seeingHistoricVersion
      ? params.historyVersion
      : globalSelectedReleaseId
    ...
    const newDocumentVersion =
      params.version === selectedPerspectiveName ? params.version : undefined
...
DocumentPaneProviderInner.displayName = 'Memo(DocumentPaneProviderInner)'
