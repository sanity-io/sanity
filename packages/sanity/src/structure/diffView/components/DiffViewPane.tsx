...
// TODO: Refactor `findRelease` to return a type compatible with `SelectedPerspective` (`"draft"` must be `"drafts"`), so that `sanitizeBundleName` can be removed.
function sanitizeBundleName(
  bundle: ReturnType<typeof findRelease>,
