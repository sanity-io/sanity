...
const commentsLocaleStrings = defineLocalesResources('comments', {
  ...
  /** Tooltip on the origin badge when a comment was created in a different document context */
  'list-item.origin.tooltip': 'This comment was not made on the document you are viewing',
