...
import {comments as commentsLegacy} from '../comments-legacy/plugin'
import {comments as commentsV2} from '../comments/plugin'
...
const defaultPlugins = (options: DefaultPluginsOptions) => [
  variants(),
  options.comments.v2 ? commentsV2() : commentsLegacy(),
  tasks(),
  scheduledPublishing(),
  releases(),
  canvasIntegration(),
