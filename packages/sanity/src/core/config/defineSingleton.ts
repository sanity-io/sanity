 ...
 *
 * Note that this produces a singleton _definition_—the registry entry binding
 ...
 * if omitted. Set it explicitly to be verbose, to guard against future
 ...
 * @beta
 */
export function defineSingleton<const Type extends Exclude<UnresolvedSingletonDefinition, string>>(
  definition: Type,
): Type {
  return definition
}
