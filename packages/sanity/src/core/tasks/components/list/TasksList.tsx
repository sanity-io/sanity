...
function TaskList(props: TaskListProps) {
  ...
  return (
    <details className={classes.detailsFlex} open={status === 'open'}>
      <Box as="summary" className={classes.summaryBox} paddingY={1}>
        <Flex align="center" gap={1} paddingY={1}>
          ...
          <Text muted size={1}>
            <ChevronDownIcon className={classes.summaryIcon} data-ui="summary-icon" />
          </Text>
        </Flex>
      </Box>
