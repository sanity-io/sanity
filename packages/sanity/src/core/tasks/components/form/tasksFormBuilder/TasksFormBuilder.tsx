...
import {createPatchChannel, FormBuilder, useEditable} from '../../../../form'
 ...
 */
type TaskDocumentInitialValue = Pick<TaskDocument, '_id' | '_type'> &
  Partial<Omit<TaskDocument, '_id' | '_type'>>
...
const TasksFormBuilderInner = ({
  ...
  const {
    ...
    schemaType,
    value,
  } = useEditable({documentId, documentType: 'tasks.task', initialValue})
