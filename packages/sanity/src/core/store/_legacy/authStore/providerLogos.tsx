...
import {customImage, fgColorVar, githubRootSvg} from './providerLogos.css'
...
const GithubLogo = () => {
  ...
  return (
    <svg
      className={githubRootSvg}
      style={assignInlineVars({[fgColorVar]: fg})}
...
export function CustomLogo(props: {provider: AuthProvider}) {
  ...
  return provider.logo ? (
    <img className={customImage} src={provider.logo} alt={`Logo for ${provider.name}`} />
  ) : undefined
}
