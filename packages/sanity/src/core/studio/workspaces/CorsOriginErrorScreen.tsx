...
export function CorsOriginErrorScreen(props: CorsOriginErrorScreenProps) {
  const {projectId, isStaging, primaryProjectId, allowed, withCredentials} = props
                ...
                <Card border padding={4} radius={4}>
                  <Flex direction="column" gap={4} height="fill">
                    <Stack space={4} flex={1}>
                      ...
                      <Text size={1} muted>
                        Adds a CORS origin for this URL (with credentials) and registers the Studio
                        so it can sync its schema and manifest with the project. Required for
                        schema-aware search, Content Agent, and other features that read the
                        deployed schema.
                      </Text>
                    </Stack>
                    <Button
              ...
              <Card border padding={4} radius={4}>
                <Flex direction="column" gap={4} height="fill">
                  <Stack space={4} flex={1}>
                    ...
                    <Text size={1} muted>
                      For local development URLs (localhost, preview deploys) where you don&apos;t
                      need schema syncing or other registered-Studio features.
                    </Text>
                  </Stack>
