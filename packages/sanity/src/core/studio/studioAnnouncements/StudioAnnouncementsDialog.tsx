...
import {dialogHeader, floatingButtonBox, root} from './StudioAnnouncementsDialog.css'
...
function Announcement({announcement, mode, isFirst, parentRef}: AnnouncementProps) {
  ...
  return (
    <Box>
      <Grid className={dialogHeader} padding={3}>
...
export function StudioAnnouncementsDialog({
  ...
  return (
    ...
    >
      <Box className={root} ref={dialogRef} height="100%">
        ...
        <Box className={floatingButtonBox}>
          <Button
