...
export function NewDocumentButton(props: NewDocumentButtonProps) {
  ...
  const placeholder = `Search ${options.length} document types`
  ...
  useClickOutside(
    (e) => {
      ...
      const targetIsOpenButton = buttonElement?.contains(e.target as Node)
      if (targetIsOpenButton) return
      ...
      <>
        ...
        {open && (
          <StyledDialog
            ...
            onClickOutside={handleDialogClose}
          ...
          >
            <RootFlex direction="column" flex={1} height="fill">
              ...
              <Flex direction="column" overflow="hidden" padding={1}>
