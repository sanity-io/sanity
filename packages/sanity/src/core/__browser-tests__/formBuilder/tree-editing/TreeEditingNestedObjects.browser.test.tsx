...
describe.skip('Tree Editing with nested objects', () => {
  it('should navigate and display nested objects correctly', async () => {
    ...
    await expect.element(nestedArrayField1).toBeVisible()
    ...
    await expect.element(nestedObjectNavigateButton1).toBeVisible()
    await expect.element(nestedObjectNavigateButton2).toBeVisible()
    ...
    await expect
      .element(stringInput)
      .toHaveValue('firstObject1.1 > secondObject > nestedArray > nestedObject1')
    ...
    await expect
      .element(stringInput)
      .toHaveValue('firstObject1.2 > secondObject > nestedArray > nestedObject2')
    ...
    await expect.element(nestedArrayField2).toBeVisible()
  })
})
