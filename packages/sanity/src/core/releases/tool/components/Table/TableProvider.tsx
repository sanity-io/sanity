...
> = ({children, defaultSort, searchTerm: controlledSearchTerm, onSearchTermChange}) => {
  const [uncontrolledSearchTerm, setUncontrolledSearchTerm] = useState<string | null>(null)
  ...
  const searchTerm = controlledSearchTerm ?? uncontrolledSearchTerm
  const setSearchTerm = useCallback(
    (newTerm: string) => {
      setUncontrolledSearchTerm(newTerm)
