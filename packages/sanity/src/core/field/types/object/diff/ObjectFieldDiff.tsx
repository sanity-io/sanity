...
import {useDocumentChange, DiffContext, NoChanges, ChangeResolver} from '../../../diff'
...
interface ObjectFieldDiffProps {
  diff: ObjectDiff
...
/** @internal */
export function ObjectFieldDiff(props: ObjectFieldDiffProps) {
