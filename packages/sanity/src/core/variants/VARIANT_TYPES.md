...
- Shows a type picker **only when more than one type is configured**.
...
- Edit never shows the picker: type is already on the document.
...
| --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Disjoint condition keys per type                                                        | Combinability rule. When the lake stores N refs, those refs still must not share keys. Validating that in config now means Phase 2 does not invent a second uniqueness model.                             |
...
What we deliberately do **not** fake while the lake is single-ref:
