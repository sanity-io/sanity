  ...
  return (
    <Fragment>
      <DocumentTable<DocumentInVariantGroup>
        // Keep the command lane (search + filter tabs) mounted during load so it doesn't pop in
        // when rows arrive — matching the release detail table and avoiding a layout jump.
