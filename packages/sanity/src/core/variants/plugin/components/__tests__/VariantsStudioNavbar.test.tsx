...
describe('VariantsStudioNavbar', () => {
  ...
  describe("the variant pill's rhombus", () => {
    ...
    it('fills when no document is open', async () => {
      await renderNavbar()
      // The design draws this pill's diamond filled in every state (`PerspectiveFilter.Variant`,
      // node 7393:12127). It used to outline here, which left the pill disagreeing with the
      // menu's own default row directly beneath it.
