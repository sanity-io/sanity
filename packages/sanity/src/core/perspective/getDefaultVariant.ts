 ...
 * Pass `selectedVariantsName` for the id, or `selectedVariants` for the definition.
 *
 * @internal
 */
export function getDefaultVariant(selectedVariantsName: readonly string[]): string | undefined
