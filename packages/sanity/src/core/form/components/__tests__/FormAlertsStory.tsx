 ...
 * Sanity UI Flex migration. Warning vs error tones, suffix divider, and
 * Details open/closed all depend on Box padding against Card tones — a mix
 * TypeScript will not catch. Copy is a fixture (no timestamps).
 */
export function FormAlertsStory() {
  return (
