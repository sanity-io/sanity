...
export const TagInput = forwardRef(
  (
    ...
    const {input, radius, font, space, card} = theme
    const spaceVal = String(rem(space[1]))
    const textFont = font.text
    const size = textFont.sizes[2]
    const p = space[2]
          ...
          <div key="tag-input" className={contentItemStyle}>
            <input
              ...
              style={assignInlineVars({
                ...
                [inputFontFamilyVar]: textFont.family,
                [inputFontWeightVar]: `${textFont.weights.regular}`,
