...
export interface BlockDecoratorProps {
   ...
   */
  renderDefault: (props: BlockDecoratorProps) => ReactElement<any>
  /**
...
export interface BlockStyleProps {
   ...
   */
  renderDefault: (props: BlockStyleProps) => ReactElement<any>
  /**
...
export interface BlockListItemProps {
   ...
   */
  renderDefault: (props: BlockListItemProps) => ReactElement<any>
  /**
...
export interface BlockAnnotationProps {
   ...
   * Plugin chain render callback.
   */
  renderDefault: (props: BlockAnnotationProps) => ReactElement<any>
  /**
   * Plugin chain render callback.
   */
...
export interface BlockProps {
   ...
   */
  renderDefault: (props: BlockProps) => ReactElement<any>
  /**
   * Plugin chain render callback.
   */
  renderField: RenderFieldCallback
