...
export const studioLocaleStrings = defineLocalesResources('studio', {
  ...
  /** Close button in the Studio diagnostics dialog */
  'diagnostics.close': 'Close',
  /** Copy button text after diagnostics output has been copied */
  'diagnostics.copied': 'Copied',
  /** Error shown when diagnostics output cannot be copied */
  'diagnostics.copy-error': 'Could not copy diagnostics',
  /** Copy button in the Studio diagnostics dialog */
  'diagnostics.copy-output': 'Copy output',
  /** Success message shown after diagnostics output has been copied */
  'diagnostics.copy-success': 'Diagnostics copied to clipboard',
  /** Title of the Studio diagnostics dialog */
  'diagnostics.dialog-title': 'Studio diagnostics',
  /** API host label in the Studio diagnostics dialog */
  'diagnostics.field.api-host': 'API host',
  /** Browser connection estimate label in the Studio diagnostics dialog */
  'diagnostics.field.connection-estimate': 'Connection estimate',
  /** Dataset label in the Studio diagnostics dialog */
  'diagnostics.field.dataset': 'Dataset',
  /** Diagnostics duration label in the Studio diagnostics dialog */
  'diagnostics.field.diagnostic-duration': 'Diagnostics duration',
  /** Document schema type count label in the Studio diagnostics dialog */
  'diagnostics.field.document-types': 'Document types',
  /** Completion time label in the Studio diagnostics dialog */
  'diagnostics.field.generated-at': 'Completed',
  /** Browser hardware label in the Studio diagnostics dialog */
  'diagnostics.field.hardware': 'Hardware',
  /** Browser language label in the Studio diagnostics dialog */
  'diagnostics.field.language': 'Language',
  /** Local storage test label in the Studio diagnostics dialog */
  'diagnostics.field.local-storage': 'Local storage',
  /** Browser maximum touch points label in the Studio diagnostics dialog */
  'diagnostics.field.max-touch-points': 'Max touch points',
  /** User name label in the Studio diagnostics dialog */
  'diagnostics.field.name': 'Name',
  /** Object schema type count label in the Studio diagnostics dialog */
  'diagnostics.field.object-types': 'Object types',
  /** Browser network status label in the Studio diagnostics dialog */
  'diagnostics.field.online': 'Online',
  /** Primitive schema type count label in the Studio diagnostics dialog */
  'diagnostics.field.primitive-types': 'Primitive types',
  /** User provider label in the Studio diagnostics dialog */
  'diagnostics.field.provider': 'Provider',
  /** Project ID label in the Studio diagnostics dialog */
  'diagnostics.field.project-id': 'Project ID',
  /** React version label in the Studio diagnostics dialog */
  'diagnostics.field.react-version': 'React version',
  /** User roles label in the Studio diagnostics dialog */
  'diagnostics.field.roles': 'Roles',
  /** Browser screen size label in the Studio diagnostics dialog */
  'diagnostics.field.screen': 'Screen',
  /** Diagnostics start time label in the Studio diagnostics dialog */
  'diagnostics.field.started-at': 'Started',
  /** Studio version label in the Studio diagnostics dialog */
  'diagnostics.field.studio-version': 'Studio version',
  /** Browser timezone label in the Studio diagnostics dialog */
  'diagnostics.field.timezone': 'Timezone',
  /** Unique project and dataset target count label in the Studio diagnostics dialog */
  'diagnostics.field.unique-targets': 'Unique targets',
  /** User agent label in the Studio diagnostics dialog */
  'diagnostics.field.user-agent': 'User agent',
  /** User ID label in the Studio diagnostics dialog */
  'diagnostics.field.user-id': 'User ID',
  /** Browser viewport label in the Studio diagnostics dialog */
  'diagnostics.field.viewport': 'Viewport',
  /** Workspace count label in the Studio diagnostics dialog */
  'diagnostics.field.workspace-count': 'Workspaces',
  /** Error shown when Studio diagnostics cannot be gathered */
  'diagnostics.gather-error': 'Could not gather diagnostics: {{error}}',
  /** Loading text while Studio diagnostics are gathered */
  ...
  'diagnostics.section.browser': 'Browser',
  /** Network section title in the Studio diagnostics dialog */
  'diagnostics.section.network': 'Network',
  /** Schema section title in the Studio diagnostics dialog */
  'diagnostics.section.schema': 'Schema',
  /** Studio section title in the Studio diagnostics dialog */
  'diagnostics.section.studio': 'Studio',
  /** User section title in the Studio diagnostics dialog */
  ...
  /** Error status in the Studio diagnostics dialog */
  'diagnostics.status.error': 'Error',
  /** Successful status in the Studio diagnostics dialog */
  'diagnostics.status.success': 'Success',
  /** Timeout status in the Studio diagnostics dialog */
  ...
  'diagnostics.value.memory': '{{memory}} GB memory',
  /** Negative value in the Studio diagnostics dialog */
  'diagnostics.value.no': 'No',
  /** Save data browser preference in the Studio diagnostics dialog */
  'diagnostics.value.save-data': 'Save data enabled',
  /** Unknown value in the Studio diagnostics dialog */
  'diagnostics.value.unknown': 'Unknown',
  /** Positive value in the Studio diagnostics dialog */
  'diagnostics.value.yes': 'Yes',
