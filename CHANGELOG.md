...
* chore: testing workflow ([8ccd2a5](https://github.com/sanity-io/sanity/commit/8ccd2a5))
* chore: using lerna full for creating release PR ([2a7a3f8](https://github.com/sanity-io/sanity/commit/2a7a3f8))
