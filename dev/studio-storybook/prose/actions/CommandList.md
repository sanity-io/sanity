...
blocks: 1
roundtrip: true
sourceHash: a2fea7122339395c
---

<!-- @component -->

How fast Studio feels is mostly this one component, and the engine itself already holds: arrow keys, Enter, virtualization and jump-by-filter all work. What lets an editor down is what gets fed into the list.
...
The page closes _in context_: the ⌘K palette an editor opens to jump to a fixture author (Austen, Tolstoy, Lem, Brontë, Woolf). Type, arrow, Enter.
