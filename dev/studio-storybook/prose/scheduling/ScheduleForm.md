...
blocks: 1
roundtrip: true
sourceHash: 48c1a47832260307
---

<!-- @component -->

ScheduleForm accepts only a future instant, and the calendar enforces that before a value is ever typed.
...
The last story shows the form in a real publish moment: picking when the "Anna Karenina" draft goes live, the emitted `{date}` payload shown below it.
