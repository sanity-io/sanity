      ...
      description: {
        component: [
          'The verb that tells a reader whether something was added, removed, or changed lives ' +
            ...
            'is carried entirely by strikethrough styling and colour, the one signal that does not ' +
            'survive being printed, screenshotted into a ticket, or read by someone with a ' +
