...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          'A dead branch here is lower-stakes than the ChangeResolver and MemberField instances of ' +
            'the same shape: it never withholds information from anyone, it just ships an ' +
