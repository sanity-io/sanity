      ...
      description: {
        component: [
          'These are the six pieces every reviewer reads a change through. A dead prop that no ' +
            'caller wires up is inert risk on its own, but a group that can look empty while still ' +
            'offering to revert changes nobody can see, and a tooltip that says a user is loading ' +
            'when no such user exists, are both things a person acts on mid-review.',
          '',
          '| | |',
          '|---|---|',
