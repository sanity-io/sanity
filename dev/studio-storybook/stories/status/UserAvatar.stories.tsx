...
const meta: Meta<typeof UserAvatar> = {
  ...
  parameters: {
    docs: {
      description: {
        component: [
          'Every face in Studio is this one component, and it does more than paint a circle: hand ' +
            'it a resolved user and it works out their identity, assigns them a deterministic ' +
            'colour, and can hang a presence dot in the corner.',
          '',
          '| | |',
          '|---|---|',
