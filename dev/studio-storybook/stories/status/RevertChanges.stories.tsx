      ...
      description: {
        component: [
          'This is a destructive action, it discards edits with no separate undo, gated by ' +
            'exactly the two things a person cannot see: a permission they may not know they lack, ' +
            'and a document-pair resolution they have no visibility into. When it fires, the ' +
            'confirmation names a count and nothing else.',
          '',
          '| | |',
          '|---|---|',
