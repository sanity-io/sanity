...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          'The two states that mean nothing to show you are distinguished by a card tone alone, ' +
            'the same colour-only pattern this program keeps finding elsewhere. And the renderer ' +
            'meant to catch a field type with no diff renderer appears to be defensive code with ' +
            'no live caller.',
          '',
          '| | |',
          '|---|---|',
