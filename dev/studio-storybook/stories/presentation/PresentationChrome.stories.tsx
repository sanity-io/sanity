...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          'Presentation is the surface where an editor works against a live preview of the ' +
            'actual front end: they click an element on the rendered page and edit the content ' +
            'behind it, right there, side by side. It is one of the most distinctive things Studio ' +
            'does, and one of the hardest to put in a Storybook, because the real tool needs a ' +
            'running frontend in an iframe, state machines, and a live connection to talk to it.',
          '',
          '| | |',
          '|---|---|',
