...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: [
          'Presence that lives in a panel is presence consulted after deciding to worry, which ' +
          ...
          '',
          'Each field row carries the real `UserAvatar` of whoever is working it right now, ' +
            'moving as they move; the document header carries the roster. And the payoff moment, ' +
            'the one the whole layer is priced against, is the collision warning: focus a field a ' +
          ...
          '',
          '> **Why it matters:** the colleagues here are simulated on a timer precisely so the ' +
            'ambient layer can be watched keeping itself true with no interaction at all. Click ' +
