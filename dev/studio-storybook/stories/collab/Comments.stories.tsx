...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          'Comments turn a document from a thing one person edits into a conversation a team ' +
            'has, and this is the surface where that conversation lives: threads pinned to the ' +
