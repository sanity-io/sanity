...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          'Sooner or later a developer needs to see the actual document: the system fields, the ' +
            'exact reference, the shape a GROQ query will return, not the friendly form on top of ' +
            'it. Inspect is that escape hatch, one menu click away and one click to close.',
          '',
          '| | |',
          '|---|---|',
          ...
          '',
          '> **Why it matters:** this is the seam done right: the raw document is reachable from *inside* the form, on demand, and gone again just as fast. Developers get ground truth without leaving the editor, and editors never have to see it unless they go looking.',
          '',
