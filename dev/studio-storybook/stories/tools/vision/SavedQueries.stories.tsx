...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          'Two kinds of saved query share one list, but they live in different worlds: personal ' +
            'queries persist in a local key-value store, private and always available, while ' +
            'shared queries are real documents in the workspace dataset that a teammate can see.',
          '',
          '| | |',
          '|---|---|',
