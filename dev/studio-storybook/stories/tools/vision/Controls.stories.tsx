...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          'Perspective is the quiet control that changes everything: raw, published, and drafts ' +
            'return different content for the same query, so a result that looks wrong is often ' +
            'just the wrong perspective selected.',
          '',
          '| | |',
          '|---|---|',
