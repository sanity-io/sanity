...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          'There is no inline diagnostics layer here: a bad query prints no underline, no gutter ' +
            'marker, nothing at all, until it is run. That gap is deliberate, but it means a typo ' +
            'hides in plain sight until execution.',
          '',
          '| | |',
          '|---|---|',
