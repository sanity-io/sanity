...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          'Unlike the query editor, the params pane validates continuously: a parse error flips ' +
            'the whole card critical and disables Fetch, so a malformed object can never reach the ' +
            'API. The catch is where the message lives, inside an icon tooltip, out of reach for ' +
