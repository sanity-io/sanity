...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          'When a query fails, the moment a person most needs to read the error clearly is exactly ' +
            'when Vision renders it hardest to see: the message prints smaller than the result it ' +
            'just replaced.',
          '',
          '| | |',
          '|---|---|',
