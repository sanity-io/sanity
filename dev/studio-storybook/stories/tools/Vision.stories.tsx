...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          'Vision is where developers go to ask the dataset a question directly. It is a full GROQ ' +
            'playground living inside Studio: type a query, press Fetch, and read exactly what the ' +
            'Content Lake returns, the same query, the same client, the same result a front end ' +
            'would get. For anyone building on Sanity it is the fastest way to confirm a query does ' +
            'what it should before wiring it into code.',
          '',
          '| | |',
          '|---|---|',
