...
const meta: Meta<typeof CollapseMenu> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          'A Studio toolbar has to survive a pane the editor is free to drag narrower, and this ' +
            'is the component that keeps it from breaking: it watches how much room is left and ' +
            'sheds the least important controls into an overflow menu rather than letting ' +
            'anything wrap, clip, or push the document title off its own header.',
          '',
          '| | |',
          '|---|---|',
          ...
          '',
          'A Studio toolbar has to survive a pane the editor is free to drag narrower, and this ' +
            'is the component that keeps it from breaking. Hand it a row of actions and it takes ' +
            'over the hard part: watching how much room is left and shedding the least important ' +
            'controls into an overflow menu, rather than letting them wrap, clip, or push the ' +
            'document title off its own header. Document headers and pane headers mount it for ' +
            'exactly that reason.',
          '',
          ...
          '',
          'The page closes *in context*: the "Anna Karenina" document header toolbar shedding ' +
            'its actions into a named overflow as the pane narrows.',
        ].join('\n'),
      },
    },
  },
