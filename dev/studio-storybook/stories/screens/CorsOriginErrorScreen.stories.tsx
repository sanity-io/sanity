...
import {CorsOriginErrorScreen} from '../../../../packages/sanity/src/core/studio/workspaces/CorsOriginErrorScreen'
import {ScreenFrame} from '../../lib/screenFrame'

const PROJECT_ID = 'ppsg7ml5'

const meta: Meta<typeof CorsOriginErrorScreen> = {
  ...
  argTypes: {
    ...
    primaryProjectId: {control: 'text'},
    origin: {control: 'text'},
    isStaging: {control: 'boolean'},
    allowed: {control: 'boolean'},
    withCredentials: {control: 'boolean'},
  },
  render: (args) => (
    <ScreenFrame height={640}>
      <CorsOriginErrorScreen {...args} />
    </ScreenFrame>
  ),
  parameters: {
    docs: {
...
export default meta
type Story = StoryObj<typeof CorsOriginErrorScreen>

export const NotConnected: Story = {
  name: 'Not connected - both options',
  parameters: {
    docs: {
      description: {
        story:
...
export const CorsOnly: Story = {
  name: 'Not connected - CORS only (localhost)',
...
export const ForeignProject: Story = {
  name: 'Not connected - a project the studio does not own',
  args: {primaryProjectId: 'someotherproject'},
  parameters: {
    docs: {
      description: {
        story:
...
export const AllowedWithoutCredentials: Story = {
  name: 'Allowed, but credentials are disabled',
