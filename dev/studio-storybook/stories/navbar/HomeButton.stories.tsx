...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          'HomeButton is the leftmost control in the Studio navbar: a quiet anchor that shows ' +
            "the active workspace's icon, or its title initial, and links back to the workspace " +
            'root. It is the one persistent "you are here, take me home" affordance in the shell.',
          '',
          '|         |                                                                                                                                                                                      |',
          '| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |',
