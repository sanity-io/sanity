...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          "The signed-in identity control at the right of the navbar is the shell's answer to " +
            '"who am I, and what can I change about my own session": it shows the current ' +
            "user's avatar and opens the personal menu: profile, the appearance and locale " +
