...
const meta: Meta<typeof PreviewCard> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          'Every row a person clicks in a list, every reference result they pick, sits inside ' +
            "one of these. This is the selectable container that gives Studio's lists their " +
            'consistent hit-area, radius, and selection look, and just as importantly, quietly ' +
            'tells the preview inside it whether it is the active row.',
          '',
          '| | |',
          '|---|---|',
