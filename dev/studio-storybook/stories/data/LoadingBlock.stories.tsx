...
const meta: Meta<typeof LoadingBlock> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          "LoadingBlock is Studio's simplest answer to the gap between asking for data and " +
            'getting it: a centred spinner, an optional delayed label, and no knowledge of what ' +
            'it is waiting for. It is used everywhere, though for list and pane regions a ' +
            'layout-shaped skeleton usually serves an editor better than a spinner over a blank ' +
            'frame.',
          '',
          '|          |                                                                                                                                                                                                                                                                                                                                         |',
          '| -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |',
          ...
          '',
          'The last story shows it in context: opening the "Anna Karenina" book. The pane ' +
            'chrome paints instantly while LoadingBlock fills the body until the document ' +
            'resolves.',
        ].join('\n'),
      },
    },
