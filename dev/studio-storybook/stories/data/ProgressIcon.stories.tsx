...
const meta: Meta<typeof ProgressIcon> = {
  ...
  parameters: {
    docs: {
      description: {
        component: [
          'A determinate progress indicator earns its place by being honest about what is known: ' +
            'when the total is known, a filling arc says exactly how much is done, not just that ' +
