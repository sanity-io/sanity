    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          weak: true,
          description:
            'Weak link to the measured commit\u2019s gitCommit document \u2014 dangles for PR-branch runs (never synced) and runs stored before the git-history sync existed. git.sha is the source of truth.',
        }),
