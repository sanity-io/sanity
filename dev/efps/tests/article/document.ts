      ...
      children: [
        {
          ...
          _type: 'span',
          marks: [],
          text: 'Remote work opens up a world of possibilities for businesses seeking talent. Companies are no longer limited by geographical boundaries when hiring, allowing them to access a diverse, global talent pool. This can lead to better hiring decisions, as businesses can choose the best experiments from a much broader selection. Additionally, remote work can help companies foster more diverse and inclusive teams by enabling them to hire individuals who may have been previously excluded due to location or mobility constraints.',
        },
      ],
      markDefs: [],
      style: 'normal',
